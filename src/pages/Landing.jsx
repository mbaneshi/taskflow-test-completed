...
const Landing = () => {
  ...
  // If not authenticated, show limited dashboard panel
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-gray-100 p-6">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl font-bold text-gray-800 mb-6">Welcome to TaskFlow</h1>
          
          {/* Dashboard Panel - Only visible when logged out */}
          <div className="bg-white rounded-lg shadow p-6">
            <h2 className="text-xl font-semibold mb-4">Dashboard Panel</h2>
            <p className="text-gray-600 mb-4">
              Please login to access the full list of tabs and features.
            </p>
            <div className="space-y-2 mb-6">
              <p className="text-sm text-gray-500">• View and manage tasks</p>
              <p className="text-sm text-gray-500">• Access team collaboration tools</p>
              <p className="text-sm text-gray-500">• Use advanced filtering and search</p>
            </div>
  ...
  // If authenticated, show full landing page with all tabs
