  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 p-6">
        ...
        {/* Task Filter Toggle - Industry standard placement */}
        <button
          onClick={() => setShowTaskFilter(!showTaskFilter)}
          className="mb-4 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition flex items-center gap-2"
        >
          <span>{showTaskFilter ? 'Hide' : 'Show'} Task Filter</span>
          <span className="text-sm">({showTaskFilter ? '▼' : '▶'})</span>
        </button>
